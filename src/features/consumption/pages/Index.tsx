    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-40 bg-background/80 backdrop-blur-md border-b border-border">
        <div className="flex items-center justify-between px-5 py-3 max-w-lg mx-auto">
          <div className="flex items-center gap-2.5">
            ...
            <h1 className="text-base font-semibold text-foreground font-sans">Consumption Tracker</h1>
          </div>
          <button
      ...
      <main className="max-w-lg mx-auto px-5 pb-12">
        ...
        <div className="mb-8 flex justify-center">
          <DetailExpander onUpdate={setPendingDetails} resetKey={messageTrigger} />
        </div>
