...
const IntroScreen: FC<IntroScreenProps> = ({ onStart }) => {
  ...
  return (
    <main className="flex flex-col items-center justify-center  px-8 py-12 text-center">
      {/* Decorative element */}
      ...
      <button
        onClick={onStart}
        className="mt-12 px-10 py-4 bg-primary text-primary-foreground font-body font-medium text-base rounded-pill  hover: active: transition-all duration-200 active:scale-[0.97] opacity-0 animate-fade-in-up-delay-3"
      >
        {t('readStories')}
      </button>
    </main>
