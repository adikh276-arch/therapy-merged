...
// Use createInstance to avoid polluting the global i18next singleton.
// This is required when multiple features are mounted under the same app.
...
instance
  ...
  .init({
    ...
    backend: {
      loadPath: '/therapy/locales/a_letter_to_self/{{lng}}.json',
    },
    interpolation: {
      escapeValue: false,
    },
