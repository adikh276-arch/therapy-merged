...
const GratitudeEntry = () => {
  ...
  return (
    <PageTransition>
      <div className="flex flex-col bg-transparent px-5 pt-12 pb-28 w-full max-w-xl mx-auto text-justify">
        ...
        {/* Sticky bottom */}
        <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-xl bg-background/80 backdrop-blur-md px-5 py-4 safe-bottom border-t border-border/50 z-10">
          <button
