      ...
      <div className="w-full max-w-md mx-auto flex flex-col px-6 py-4 min-h-[70vh]">
        <AnimatePresence mode="wait">
          {screen === "welcome" && (
            ...
            >
              <div className="w-24 h-24 bg-rose-50 rounded-[2.5rem] flex items-center justify-center text-5xl shadow-2xl animate-pulse"><Feather className="inline-block w-8 h-8" /></div>
              ...
              <div className="space-y-6 text-slate-500 font-medium leading-relaxed max-w-xs mx-auto text-base">
                ...
                <div className="bg-white/60 backdrop-blur-lg border border-white/60 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-3xl p-6 shadow-xl shadow-slate-200/50 italic text-slate-400">
              ...
              <div className="w-full space-y-4">
                <button
                  ...
                  className="w-full bg-slate-900 text-white shadow-md py-5 rounded-2xl font-black text-lg shadow-2xl hover:opacity-90 transition-all flex items-center justify-center gap-3"
                >
                ...
                {entries.length > 0 && (
                  <button
                    ...
                    className="w-full bg-white text-slate-600 py-5 rounded-2xl font-black text-lg border border-slate-250 hover:bg-slate-50 transition-all flex items-center justify-center gap-3 shadow-sm"
                  >
            ...
            >
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full bg-white/60 backdrop-blur-lg border border-white/60 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-3xl px-8 py-5 text-slate-800 text-lg font-black placeholder:text-slate-200 focus:ring-4 focus:ring-primary/5 focus:border-primary/20 transition-all shadow-xl shadow-slate-200/50"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full bg-white/60 backdrop-blur-lg border border-white/60 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-3xl px-8 py-4 text-slate-800 text-base font-bold placeholder:text-slate-200 focus:ring-4 focus:ring-primary/5 focus:border-primary/20 transition-all shadow-lg shadow-slate-200/40"
                  />
                </div>
              </div>
              ...
              <AnimatePresence>
                {showCue && (
                  <motion.div
                    ...
                    animate="visible"
                    exit="hidden"
                    className="bg-rose-50/50 border border-rose-100 rounded-[2.5rem] p-8 text-center space-y-4 shadow-inner"
                  >
                    <Heart className="w-8 h-8 text-rose-400 animate-pulse mx-auto" />
                    <p className="text-slate-650 font-bold italic leading-relaxed text-base">
                ...
                {showPrompt && (
                  ...
                  >
                    <div className="text-center space-y-2 px-4">
                      <p className="text-slate-850 font-black text-lg leading-snug">
              ...
              <div className="mt-auto py-6">
                <button
                  ...
                  disabled={!wish.trim()}
                  className="w-full bg-slate-900 text-white shadow-md py-5 rounded-2xl font-black text-lg shadow-2xl hover:opacity-90 transition-all flex items-center justify-center gap-3 disabled:opacity-20"
                >
          ...
          {screen === "carry" && (
            ...
            >
              ...
              <p className="text-center text-slate-500 leading-relaxed max-w-sm mx-auto">
              ...
              <div className="space-y-4">
                <p className="text-sm font-black text-slate-700 text-center uppercase tracking-wider block">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-white/60 backdrop-blur-lg border border-white/60 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-2xl px-6 py-4 text-slate-800 placeholder:text-slate-200 font-medium text-base focus:ring-4 focus:ring-primary/5 transition-all resize-none shadow-sm"
                />
                <p className="text-xs text-slate-400 text-center font-semibold max-w-[280px] mx-auto leading-relaxed">
              ...
              <div className="mt-auto pt-8 space-y-3 w-full">
                <button
                  disabled={isSaving}
                  className="w-full bg-slate-900 text-white shadow-md py-5 rounded-2xl font-black text-lg hover:opacity-90 transition-all flex items-center justify-center gap-2"
                  onClick={saveEntry}
                >
                  {isSaving ? t("saving...", "Preserving...") : t("save_button", "Preserve Tribute")}
                </button>
                <button
                  className="w-full bg-white text-slate-400 py-4 rounded-xl font-bold text-sm border border-dashed border-slate-200 hover:text-slate-650"
                  onClick={saveEntry}
                >
          ...
          {screen === "reflection" && (
            ...
            >
              ...
              >
                <div className="bg-white rounded-3xl p-6 w-full space-y-5 shadow-sm border border-slate-100 my-4 text-left">
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 leading-relaxed font-bold italic">"{wish}"</p>
                  </div>
                  {smallStep && (
                    <div>
                      <p className="text-[10px] text-slate-400 uppercase tracking-widest font-black mb-1">
                      ...
                      <p className="text-slate-600 leading-relaxed font-bold">"{smallStep}"</p>
                    </div>
                  )}
                </div>
              </PremiumComplete>
          ...
          {screen === "past" && (
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto pr-2 space-y-6 max-h-[50vh]">
                {entries.length === 0 ? (
                  <div className="bg-white border border-white/60 rounded-[2.5rem] p-12 text-center shadow-xl space-y-6">
                    <div className="w-16 h-16 bg-white/40 backdrop-blur-sm shadow-sm border border-white/50 rounded-2xl flex items-center justify-center mx-auto text-3xl"><Hourglass className="inline-block w-8 h-8" /></div>
                  ...
                  <div className="space-y-6">
                    {entries.map((entry, i) => (
                      <motion.div
                        ...
                        className="bg-white/60 backdrop-blur-lg border border-white/60 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-[2.5rem] p-8 shadow-2xl space-y-4 hover:shadow-primary/5 transition-all duration-300"
                      >
                        ...
                        <div className="space-y-3">
                          <p className="text-slate-850 font-black text-xl leading-tight">
                          ...
                          <div className="relative">
                            ...
                            <p className="pl-6 text-slate-650 text-base leading-relaxed font-bold italic">
                              "{entry.wish}"
                            </p>
                          </div>
                        </div>
              ...
              <button
                ...
                className="w-full bg-white text-slate-650 py-5 rounded-2xl font-black text-lg border border-slate-200 hover:bg-slate-50 transition-all flex items-center justify-center gap-3 shadow-sm"
              >
