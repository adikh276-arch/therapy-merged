  ...
  return (
    <div className="max-w-md mx-auto px-6 py-8 min-h-screen flex flex-col items-center justify-center">
      <div className="text-center animate-fade-in">
        <h1 className="text-3xl font-bold text-foreground mb-2">{t("brain_dump_and_sort.reflection_title")}</h1>
        <p className="text-muted-foreground text-sm mb-10">{t("brain_dump_and_sort.reflection_desc")}</p>
      </div>
      ...
      {selected && (
        ...
        >
          {t("brain_dump_and_sort.finish_session")}
        </button>
      )}
