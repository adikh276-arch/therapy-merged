...
const ReflectionScreen = ({ onNext }: { onNext: () => void }) => {
  ...
  return (
    <div className="bg-card rounded-2xl p-6 shadow-sm border border-border flex flex-col gap-5">
      ...
      <h2 className="text-xl font-semibold text-foreground">{t("what_are_your_habits.reflection_title")}</h2>
      <div className="flex flex-col gap-4">
        <div>
          <label className="text-sm font-medium text-foreground mb-1.5 block text-justified">
            {t("what_are_your_habits.question_stress")}
          </label>
          <textarea
            value={stress}
        ...
        <div>
          <label className="text-sm font-medium text-foreground mb-1.5 block text-justified">
            {t("what_are_your_habits.question_calm")}
          </label>
          <textarea
            value={calm}
      ...
      <ActivityButton label={t("what_are_your_habits.see_insight")} onClick={onNext} />
    </div>
  );
};
