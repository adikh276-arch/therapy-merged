...
import GroundingCard from "@/app/therapy/grounded-technique/components/GroundingCard";
    ...
    <div className="min-h-screen relative overflow-hidden" style={{
      ...
      <div className="relative z-10 max-w-md mx-auto min-h-screen flex flex-col">
        ...
        <header className="flex items-center justify-between px-5 pt-6 pb-2 safe-area-top">
          ...
          <h1 className="text-lg font-bold text-foreground">{t("grounded_technique.Grounding")}</h1>
