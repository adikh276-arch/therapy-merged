...
import { techniques } from "@/app/therapy/grounded-technique/data/techniques";
import { useTranslation } from "@/app/therapy/grounded-technique/hooks/useTranslation";
import LanguageSwitcher from "@/app/therapy/grounded-technique/components/LanguageSwitcher";
  ...
  if (!technique) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-background">
        <p className="text-muted-foreground">{t("grounded_technique.Technique not found")}</p>
      </div>
    );
  }
      ...
      <div className="relative z-10 max-w-md mx-auto min-h-screen flex flex-col">
        ...
        <div className="px-6 pb-6">
          ...
          <p className="text-xs text-muted-foreground mt-2">
            {t("grounded_technique.Step")} {currentStep + 1} / {totalSteps}
          </p>
        </div>
        ...
        <div className="px-6 pb-6 pt-4 space-y-3">
          ...
          <div className="flex gap-3">
            ...
            >
              {isLastStep ? t("grounded_technique.I Feel More Grounded") : t("grounded_technique.Next")}
          ...
          >
            {t("grounded_technique.Choose Another Technique")}
          </button>
        </div>
      </div>
    </div>
