...
import { getDoodleHistory, deleteDoodle, groupByDate, type DoodleEntry } from "@/app/therapy/doodle-burst/lib/doodleHistory";
...
const DoodleHistory = () => {
  ...
  const formatDate = (dateStr: string) => {
    ...
    if (dateStr === todayStr) return t("doodle_burst.today");
    if (dateStr === yesterdayStr) return t("doodle_burst.yesterday");
    ...
    <div className="min-h-screen bg-playful p-4">
      ...
      <div className="max-w-lg mx-auto py-8">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-black text-foreground">{t("doodle_burst.history_title")} 📒</h1>
            <p className="text-sm text-muted-foreground">
              {entries.length} {entries.length === 1 ? t("doodle_burst.doodle") : t("doodle_burst.doodles")} {t("doodle_burst.saved")}
            </p>
          </div>
        </div>
        ...
        {entries.length === 0 && (
          ...
          >
            ...
            <p className="text-lg font-bold text-foreground mb-2">{t("doodle_burst.no_doodles")}</p>
            <p className="text-muted-foreground text-center">
              {t("doodle_burst.history_empty_desc")}
            </p>
          </motion.div>
        )}
