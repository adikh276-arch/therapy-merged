  ...
  return (
    ...
    >
      ...
      <h1 className="font-heading text-[22px] font-medium text-foreground mb-8">
        {t("daily_gratitude_diary.past_entries_title")}
      </h1>

      {entries.length === 0 ? (
        <p className="text-muted-foreground leading-[1.7]">
          {t("daily_gratitude_diary.no_entries")}
        </p>
      ) : (
            ...
            >
              ...
              {entry.feeling && (
                <p className="text-muted-foreground text-sm italic pt-1 text-center">
                  {t("daily_gratitude_diary.feeling_label")}{entry.feeling}
                </p>
              )}
            </motion.div>
          ))}
