  ...
  return (
    ...
    >
      ...
      <h1 className="font-heading text-[22px] font-medium text-foreground mb-3">
        {t("daily_gratitude_diary.closing_title")}
      </h1>

      <div className="space-y-5 mb-12 max-w-sm">
        <p className="text-foreground leading-[1.7]">
          {t("daily_gratitude_diary.closing_text_1")}
        </p>
        <p className="text-foreground leading-[1.7]">
          {t("daily_gratitude_diary.closing_text_2")}
        </p>
        <p className="text-muted-foreground leading-[1.7] italic">
          {t("daily_gratitude_diary.closing_italic")}
        </p>
      </div>
      ...
      <div className="w-full max-w-sm space-y-3">
        ...
        >
          {t("daily_gratitude_diary.view_past")}
        </motion.button>
