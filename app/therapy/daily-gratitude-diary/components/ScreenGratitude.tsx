...
import cherryBlossom from "@/app/therapy/daily-gratitude-diary/assets/cherry-blossom.png";
  ...
  return (
    ...
    >
      ...
      <h1 className="font-heading text-[22px] font-medium text-foreground mb-3">
        {t("daily_gratitude_diary.grateful_title")}
      </h1>

      <div className="space-y-3 mb-8 max-w-sm">
        <p className="text-foreground leading-[1.7]">{t("daily_gratitude_diary.grateful_step_1")}</p>
        <p className="text-foreground leading-[1.7]">
          {t("daily_gratitude_diary.grateful_step_2")}
        </p>
        <p className="text-muted-foreground leading-[1.7]">{t("daily_gratitude_diary.grateful_step_3")}</p>
      </div>
      ...
      <div className="w-full max-w-sm space-y-6 mb-10">
        {entries.map((entry, i) => (
          ...
          >
            <input
              type="text"
              placeholder={t("daily_gratitude_diary.placeholder_grateful")}
            ...
            <input
              type="text"
              placeholder={t("daily_gratitude_diary.placeholder_reason")}
              value={entry.reason}
      ...
      <div className="w-full max-w-sm space-y-3">
        ...
        >
          {t("daily_gratitude_diary.add_another")}
        </motion.button>
        ...
        >
          {t("daily_gratitude_diary.continue")}
        </motion.button>
      </div>
    </motion.div>
  );
