  ...
  return (
    ...
    >
      ...
      <h1 className="font-heading text-[22px] font-medium text-foreground mb-3">
        {t("daily_gratitude_diary.app_title")}
      </h1>

      <p className="text-muted-foreground text-base mb-8">
        {t("daily_gratitude_diary.app_subtitle")}
      </p>

      <div className="space-y-5 mb-12 max-w-sm">
        <p className="text-foreground leading-[1.7]">
          {t("daily_gratitude_diary.intro_text_1")}
        </p>
        <p className="text-foreground leading-[1.7]">
          {t("daily_gratitude_diary.intro_text_2")}
        </p>
        <p className="text-foreground leading-[1.7]">
          {t("daily_gratitude_diary.intro_text_3")}
        </p>
        <p className="text-muted-foreground leading-[1.7] italic">
          {t("daily_gratitude_diary.intro_text_italic")}
        </p>
      </div>
      ...
      >
        {t("daily_gratitude_diary.start_button")}
      </motion.button>
    </motion.div>
  );
};
