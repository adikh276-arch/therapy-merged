...
import ScreenIntro from "@/app/therapy/daily-gratitude-diary/components/ScreenIntro";
import ScreenGratitude from "@/app/therapy/daily-gratitude-diary/components/ScreenGratitude";
import ScreenReflection from "@/app/therapy/daily-gratitude-diary/components/ScreenReflection";
import ScreenClosing from "@/app/therapy/daily-gratitude-diary/components/ScreenClosing";
import ScreenPastEntries from "@/app/therapy/daily-gratitude-diary/components/ScreenPastEntries";
import { dbRequest } from "@/app/therapy/daily-gratitude-diary/lib/db";
...
const Index = () => {
  ...
  const saveEntry = async (feeling: string) => {
    ...
    if (userId) {
      try {
        await dbRequest("INSERT INTO gratitude_entries (user_id, date, feeling, gratitudes) VALUES ($1, $2, $3, $4)",
