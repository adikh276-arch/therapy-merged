    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12 fade-enter">
      <div className="max-w-md w-full text-center space-y-8">
        ...
        <div className="space-y-3">
          <h1 className="text-3xl font-heading">{t("a_letter_to_self.title")}</h1>
          <p className="text-muted-foreground text-lg">
            {t("a_letter_to_self.subtitle")}
          </p>
        </div>

        <p className="text-justified text-foreground/80 leading-relaxed px-2">
          {t("a_letter_to_self.intro_text")}
        </p>
        ...
        <div className="space-y-3 pt-2">
          ...
          >
            {t("a_letter_to_self.start_writing")}
          </Button>
          <Button
            variant="outline"
            ...
            className="w-full rounded-2xl h-12 text-base font-medium"
          >
            {t("a_letter_to_self.view_past_letters")}
          </Button>
        </div>

        <p className="text-muted-foreground text-sm pt-4 flex items-center justify-center gap-1.5">
          {t("a_letter_to_self.no_judgments")} <Leaf className="w-4 h-4 text-accent-foreground" />
        </p>
      </div>
    </div>
  );
