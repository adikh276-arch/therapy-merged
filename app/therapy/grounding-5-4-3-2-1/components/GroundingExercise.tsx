...
import ProgressDots from "@/app/therapy/grounding-5-4-3-2-1/components/ProgressDots";
import GroundingButton from "@/app/therapy/grounding-5-4-3-2-1/components/GroundingButton";
import StepInput from "@/app/therapy/grounding-5-4-3-2-1/components/StepInput";
...
const GroundingExercise = () => {
  ...
  const steps = useMemo(() => {
    ...
    const stepsData = t("grounding_5_4_3_2_1.steps", { returnObjects: true }) as any[];
