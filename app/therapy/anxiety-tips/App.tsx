"use client";
import { Toaster } from "@/app/therapy/anxiety-tips/components/ui/toaster";
import { Toaster as Sonner } from "@/app/therapy/anxiety-tips/components/ui/sonner";
import { TooltipProvider } from "@/app/therapy/anxiety-tips/components/ui/tooltip";
...
const App = () => (
  <QueryClientProvider client={queryClient}>
    <TooltipProvider>
      ...
      <Toaster />
      <Sonner />
      <BrowserRouter basename="/therapy/anxiety-tips">
        <Routes>
