    ...
    <div className="space-y-6">
      ...
      <div className="text-center space-y-1">
        <h2 className="text-2xl font-extrabold text-foreground">
          {t("self_care_bingo.lets_play")}
        </h2>
        <p className="text-muted-foreground text-sm">
          {t("self_care_bingo.instructions").split("BINGO!")[0]}
      ...
      <div className="bg-card rounded-2xl p-4 shadow-sm border border-border">
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm font-semibold text-foreground">{t("self_care_bingo.progress_title")}</span>
          <span className="text-sm text-muted-foreground">{t("self_care_bingo.progress_count", { count: progress })}</span>
        </div>
