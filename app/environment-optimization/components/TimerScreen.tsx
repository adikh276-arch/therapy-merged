...
import { Button } from "@/app/environment-optimization/components/ui/button";
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-6 py-12 animate-fade-in">
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <div>
          <p className="text-xs uppercase tracking-widest text-primary font-semibold mb-1">{t("environment_optimization.step_2_of_3")}</p>
          <h1 className="text-3xl font-heading font-bold text-foreground">
            {t("environment_optimization.five_min_reset")}
          </h1>
        </div>
        ...
        <div className="bg-card rounded-2xl p-5 shadow-sm border border-border space-y-3">
          <p className="text-muted-foreground text-left leading-relaxed text-sm">
            {t("environment_optimization.next_5_minutes")}
          </p>
          <ul className="text-left text-foreground space-y-2 text-sm">
            <li className="flex items-start gap-2">
              <span className="text-primary mt-0.5">•</span> {t("environment_optimization.remove_trash")}
            </li>
            <li className="flex items-start gap-2">
              <span className="text-primary mt-0.5">•</span> {t("environment_optimization.put_away_items")}
            </li>
            <li className="flex items-start gap-2">
              <span className="text-primary mt-0.5">•</span> {t("environment_optimization.neatly_place_remains")}
            </li>
          </ul>
          <p className="text-muted-foreground text-left text-xs italic">
            {t("environment_optimization.not_perfect")}
          </p>
        </div>
        ...
        <p className="text-xs text-muted-foreground">
          {soundEnabled ? t("environment_optimization.chime_done") : t("environment_optimization.sound_off")}
        </p>
        ...
        >
          ...
          {t("environment_optimization.im_done")}
        </Button>
      </div>
    </div>
  );
