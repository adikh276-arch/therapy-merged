  ...
  return (
    <div className="flex flex-col items-stretch gap-3 w-full">
      ...
      <div className="flex justify-center gap-2">
        <ToolButton icon={<Pen size={18} />} label={t("doodle_burst.tool_pen")} active />
        <ToolButton icon={<Undo2 size={18} />} label={t("doodle_burst.tool_undo")} onClick={undo} />
        <ToolButton icon={<Trash2 size={18} />} label={t("doodle_burst.tool_clear")} onClick={clearCanvas} />
      </div>
