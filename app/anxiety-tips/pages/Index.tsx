  ...
  const tips = [
    {
      ...
      preview: t("anxiety_tips.tip_seek_support_desc"),
      icon: Heart,
      bgClass: "bg-icon-1",
    },
    {
      ...
      preview: t("anxiety_tips.tip_deep_breathing_desc"),
      icon: Wind,
      bgClass: "bg-icon-2",
    },
    {
      ...
      preview: t("anxiety_tips.tip_mindfulness_desc"),
      icon: Eye,
      bgClass: "bg-icon-3",
    },
    {
      ...
      preview: t("anxiety_tips.tip_muscle_relaxation_desc"),
      icon: Dumbbell,
      bgClass: "bg-icon-4",
    },
    {
      ...
      preview: t("anxiety_tips.tip_positive_self_talk_desc"),
    ...
    <div className="min-h-screen gradient-calm">
      <div className="max-w-md mx-auto px-5 py-8 pb-12">
        ...
        <div className="mb-8 animate-fade-in">
          <p className="text-muted-foreground text-sm font-semibold mb-1">{t("anxiety_tips.slow_down")}</p>
          <h1 className="text-3xl font-extrabold text-foreground leading-tight">
            {t("anxiety_tips.app_title")}
          </h1>
          <p className="text-muted-foreground mt-2 text-base leading-relaxed">
            {t("anxiety_tips.app_subtitle")}
          </p>
        </div>

        {/* Section Title */}
        <h2 className="text-lg font-bold text-foreground mb-4">{t("anxiety_tips.relief_tips")}</h2>
