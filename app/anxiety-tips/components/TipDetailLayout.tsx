    ...
    <div className="min-h-screen gradient-calm">
      <div className="max-w-md mx-auto px-5 py-6 pb-12">
        ...
        >
          ...
          <span className="text-sm font-semibold">{t("anxiety_tips.back")}</span>
        </button>
        ...
        <section className="mb-6 animate-fade-in" style={{ animationDelay: "80ms", animationFillMode: "both" }}>
          <h2 className="text-base font-bold text-foreground mb-2">{t("anxiety_tips.why_it_helps")}</h2>
        ...
        <section className="mb-6 animate-fade-in" style={{ animationDelay: "160ms", animationFillMode: "both" }}>
          <h2 className="text-base font-bold text-foreground mb-3">{t("anxiety_tips.what_you_can_do")}</h2>
