...
import ValueChip from "@/app/personal-mission-statement/components/ValueChip";
    ...
    <ScreenWrapper screenKey="values">
      <div className="flex-1 space-y-6">
        <h1 className="text-[22px] font-heading text-foreground text-center">
          {t("personal_mission_statement.values_title")}
        </h1>

        <p className="text-[15px] font-body text-muted-foreground leading-[1.65] text-center">
          {t("personal_mission_statement.values_subtitle")}
        </p>
      ...
      <div className="pt-8 pb-4">
        <MissionButton onClick={onNext} disabled={selected.length === 0}>
          {t("personal_mission_statement.values_next")}
        </MissionButton>
      </div>
    </ScreenWrapper>
  );
