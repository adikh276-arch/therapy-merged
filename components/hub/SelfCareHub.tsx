...
const topicDetails: Record<string, {
  ...
  anxiety: {
    ...
    resources: [
      ...
      { titleKey: "hub.myths", count: 10, icon: HelpCircle, url: "/concerns/anxiety/myths" },
    ],
  },
  stress: {
    ...
    resources: [
      { titleKey: "hub.articles", count: 28, icon: Newspaper, url: "/concerns/stress/articles" },
      { titleKey: "hub.tips", count: 20, icon: Lightbulb, url: "/stress-tips" },
      { titleKey: "hub.stories", count: 10, icon: BookMarked, url: "/concerns/stress/stories" },
      { titleKey: "hub.myths", count: 6, icon: HelpCircle, url: "/concerns/stress/myths" },
    ],
  },
  sleep: {
    ...
    resources: [
      { titleKey: "hub.articles", count: 20, icon: Newspaper, url: "/concerns/sleep/articles" },
      { titleKey: "hub.tips", count: 15, icon: Lightbulb, url: "/sleep-guide" },
      { titleKey: "hub.stories", count: 10, icon: BookMarked, url: "/concerns/sleep/stories" },
      { titleKey: "hub.myths", count: 7, icon: HelpCircle, url: "/concerns/sleep/myths" },
    ],
  },
  adolescent: {
    ...
    resources: [
      { titleKey: "hub.articles", count: 18, icon: Newspaper, url: "/concerns/adolescent/articles" },
      { titleKey: "hub.tips", count: 14, icon: Lightbulb, url: "/concerns/adolescent/tips" },
      { titleKey: "hub.stories", count: 10, icon: BookMarked, url: "/concerns/adolescent/stories" },
      { titleKey: "hub.myths", count: 6, icon: HelpCircle, url: "/concerns/adolescent/myths" },
    ],
  },
  relationship: {
    ...
    resources: [
      { titleKey: "hub.articles", count: 22, icon: Newspaper, url: "/concerns/relationship/articles" },
      { titleKey: "hub.tips", count: 16, icon: Lightbulb, url: "/concerns/relationship/tips" },
      { titleKey: "hub.stories", count: 12, icon: BookMarked, url: "/concerns/relationship/stories" },
      { titleKey: "hub.myths", count: 8, icon: HelpCircle, url: "/concerns/relationship/myths" },
    ],
  },
  workplace: {
    ...
    resources: [
      ...
      { titleKey: "hub.tips", count: 18, icon: Lightbulb, url: "/concerns/workplace/tips" },
      { titleKey: "hub.stories", count: 10, icon: BookMarked, url: "/concerns/workplace/stories" },
      { titleKey: "hub.myths", count: 7, icon: HelpCircle, url: "/concerns/workplace/myths" },
    ],
  },
  parenting: {
    ...
    resources: [
      { titleKey: "hub.articles", count: 20, icon: Newspaper, url: "/concerns/parenting/articles" },
      { titleKey: "hub.tips", count: 15, icon: Lightbulb, url: "/concerns/parenting/tips" },
      { titleKey: "hub.stories", count: 10, icon: BookMarked, url: "/concerns/parenting/stories" },
      { titleKey: "hub.myths", count: 6, icon: HelpCircle, url: "/concerns/parenting/myths" },
    ],
  },
  anger: {
    ...
    resources: [
      ...
      { titleKey: "hub.stories", count: 8, icon: BookMarked, url: "/concerns/anger/stories" },
      { titleKey: "hub.myths", count: 5, icon: HelpCircle, url: "/concerns/anger/myths" },
    ],
  },
  grief: {
    ...
    resources: [
      ...
      { titleKey: "hub.tips", count: 12, icon: Lightbulb, url: "/concerns/grief/tips" },
      { titleKey: "hub.stories", count: 10, icon: BookMarked, url: "/concerns/grief/stories" },
      { titleKey: "hub.myths", count: 6, icon: HelpCircle, url: "/concerns/grief/myths" },
    ],
  },
  ptsd: {
    ...
    resources: [
      ...
      { titleKey: "hub.tips", count: 15, icon: Lightbulb, url: "/concerns/ptsd/tips" },
      { titleKey: "hub.stories", count: 10, icon: BookMarked, url: "/concerns/ptsd/stories" },
      { titleKey: "hub.myths", count: 7, icon: HelpCircle, url: "/concerns/ptsd/myths" },
    ],
  },
  acceptance: {
    ...
    resources: [
      ...
      { titleKey: "hub.tips", count: 12, icon: Lightbulb, url: "/concerns/acceptance/tips" },
      { titleKey: "hub.stories", count: 8, icon: BookMarked, url: "/concerns/acceptance/stories" },
      { titleKey: "hub.myths", count: 5, icon: HelpCircle, url: "/concerns/acceptance/myths" },
    ],
  },
  postpartum: {
    ...
    resources: [
      { titleKey: "hub.articles", count: 18, icon: Newspaper, url: "/concerns/postpartum/articles" },
      { titleKey: "hub.tips", count: 14, icon: Lightbulb, url: "/concerns/postpartum/tips" },
      { titleKey: "hub.stories", count: 10, icon: BookMarked, url: "/concerns/postpartum/stories" },
      { titleKey: "hub.myths", count: 6, icon: HelpCircle, url: "/concerns/postpartum/myths" },
    ],
  },
  sexuality: {
    ...
    resources: [
      { titleKey: "hub.articles", count: 16, icon: Newspaper, url: "/concerns/sexuality/articles" },
      { titleKey: "hub.tips", count: 12, icon: Lightbulb, url: "/concerns/sexuality/tips" },
      { titleKey: "hub.stories", count: 8, icon: BookMarked, url: "/concerns/sexuality/stories" },
      { titleKey: "hub.myths", count: 5, icon: HelpCircle, url: "/concerns/sexuality/myths" },
    ],
  },
  "eating-disorder": {
    ...
    resources: [
      { titleKey: "hub.articles", count: 18, icon: Newspaper, url: "/concerns/eating-disorder/articles" },
      { titleKey: "hub.tips", count: 14, icon: Lightbulb, url: "/concerns/eating-disorder/tips" },
      { titleKey: "hub.stories", count: 10, icon: BookMarked, url: "/concerns/eating-disorder/stories" },
      { titleKey: "hub.myths", count: 6, icon: HelpCircle, url: "/concerns/eating-disorder/myths" },
    ],
  },
  ocd: {
    ...
    resources: [
      { titleKey: "hub.articles", count: 20, icon: Newspaper, url: "/concerns/ocd/articles" },
      { titleKey: "hub.tips", count: 15, icon: Lightbulb, url: "/concerns/ocd/tips" },
      { titleKey: "hub.stories", count: 10, icon: BookMarked, url: "/concerns/ocd/stories" },
      { titleKey: "hub.myths", count: 7, icon: HelpCircle, url: "/concerns/ocd/myths" },
    ],
  },
};
